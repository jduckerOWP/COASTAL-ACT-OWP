...
%   $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/tools_lgpl/matlab/quickplot/progsrc/d3d_qp.m $
%   $Id: d3d_qp.m 140618 2022-01-12 13:12:04Z klapwijk $
try
    if nargin==0
        cmd='initialize';
    end
