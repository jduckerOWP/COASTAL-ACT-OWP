...
!-----------------------------------------------------------------------
!
!#if defined ("(Jason.Ducker) Thu Sep 29 14:36:15 UTC 2022 rUnversioned directory ") && defined (2022) && defined (272)
!      if (mype==0) call w3tagb('NEMS '//"(Jason.Ducker) Thu Sep 29 14:36:15 UTC 2022 rUnversioned directory ",                       &
!                               2022, 272, 0000, 'NEMS')
!#else
