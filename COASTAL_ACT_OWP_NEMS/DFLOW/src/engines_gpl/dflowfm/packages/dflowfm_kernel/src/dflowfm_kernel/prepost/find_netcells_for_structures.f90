...
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/dflowfm/packages/dflowfm_kernel/src/dflowfm_kernel/prepost/find_netcells_for_structures.f90 $
...
subroutine find_netcells_for_structures(nstrucells, istrucells)
   ...
   character(len=256), allocatable :: pli_id(:)
   ...
   do i=1,nstr
      ...
      if (loc_spec_type == LOCTP_POLYLINE_FILE) then
        ...
        call read1polylin(minp_tmp,xpl_tmp,ypl_tmp,pli_id,npl_tmp)
      end if
