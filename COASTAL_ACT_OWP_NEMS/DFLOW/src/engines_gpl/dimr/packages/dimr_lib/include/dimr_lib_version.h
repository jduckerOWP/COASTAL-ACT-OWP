...
#define modname_sourcecode_url "@(#) $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/dimr/packages/dimr_lib/include/dimr_lib_version.h.svn $"
