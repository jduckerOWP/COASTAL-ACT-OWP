...
export DFLOW_BUILDLIBS="/scratch2/COASTAL/coastal/noscrub/Jason.Ducker/DFlowFM_2022.03/build_all/install"
...
# netcdf
# export NETCDFLIBS=/apps/netcdf/4.7.0/intel/18.0.5.274/lib

export DFLOW_LIB_PATH="$DFLOW_CAPDIR/lib"

export PKG_CONFIG_PATH="$PETSC_LIB_PATH/pkgconfig:$PKG_CONFIG_PATH"
export LD_LIBRARY_PATH="$PETSC_LIB_PATH:$METIS_LIB_PATH:$DFLOW_LIB_PATH:$LD_LIBRARY_PATH"
