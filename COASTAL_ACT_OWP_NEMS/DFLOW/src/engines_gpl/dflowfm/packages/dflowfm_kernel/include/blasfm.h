...
#define dnrm2_dflow(N, X, INCX) dnrm2XXX(n, vv, 1)
#define ddot_dflow(N, DX, INCX, DY, INCY) ddotXXX(N, DX, INCX, DY, INCY)
#define daxpy_dflow(N, DA, DX, INCX, DY, INCY) daxpyXXX(N, DA, DX, INCX, DY, INCY)
#define amux_dflow(n, x, y, a, ja, ia) amuxXXX(n, x, y, a, ja, ia) 

#define EXTERNAL_DNRM2 double precision, external :: dnrm2_dflow
#define EXTERNAL_DDOT  double precision, external :: ddot_dflow
