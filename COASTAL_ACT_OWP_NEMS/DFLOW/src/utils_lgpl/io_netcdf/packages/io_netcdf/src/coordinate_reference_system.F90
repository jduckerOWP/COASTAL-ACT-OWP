...
!  $Id: coordinate_reference_system.F90 140618 2022-01-12 13:12:04Z klapwijk $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/utils_lgpl/io_netcdf/packages/io_netcdf/src/coordinate_reference_system.F90 $
#ifdef HAVE_CONFIG_H
#include "config.h"
#endif
