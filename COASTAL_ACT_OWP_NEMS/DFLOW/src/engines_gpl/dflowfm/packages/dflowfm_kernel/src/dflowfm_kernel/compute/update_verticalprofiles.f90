...
! $Id: update_verticalprofiles.f90 140618 2022-01-12 13:12:04Z klapwijk $
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/dflowfm/packages/dflowfm_kernel/src/dflowfm_kernel/compute/update_verticalprofiles.f90 $
...
!    vicwwu = vicoww
 ...
 !
     ...
     call tridag_dflow(ak,bk,ck,dk,ek,turkin1(Lb0:Lt),kxL+1)                    ! solve k
    ...
    call tridag_dflow(ak,bk,ck,dk,ek,tureps1(Lb0:Lt),kxL+1)         ! solve eps
    ...
    if (javatest == 3) then      ! test advection
      ...
      call tridag_dflow(ak,bk,ck,dk,ek,tttu(Lb0:Lt),kxL+1)     ! solve tttu
