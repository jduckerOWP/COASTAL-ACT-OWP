...
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/wave/packages/manager/src/wave_version.F90.svn $
!
...
subroutine getfullversionstring_wave(stringout)
   ...
   character(*), parameter :: wave_build_number = '141013'
...
subroutine getsourcecodelocation_wave(stringout)
   ...
   character(*), parameter :: deltares_common_source_code  = '@(#) $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/wave/packages/manager/src/wave_version.F90.svn $'//char(0)
