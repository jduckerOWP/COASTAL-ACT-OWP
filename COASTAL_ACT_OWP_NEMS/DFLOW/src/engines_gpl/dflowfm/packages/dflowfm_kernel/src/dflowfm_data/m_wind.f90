...
! $Id: m_wind.f90 140618 2022-01-12 13:12:04Z klapwijk $
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/engines_gpl/dflowfm/packages/dflowfm_kernel/src/dflowfm_data/m_wind.f90 $
...
double precision, allocatable, target :: qplat_test(:), qplat_t0(:), qplat_t1(:)         !< [m3/s] Lateraldischarge of provider {"shape": ["numlatsg"]}
