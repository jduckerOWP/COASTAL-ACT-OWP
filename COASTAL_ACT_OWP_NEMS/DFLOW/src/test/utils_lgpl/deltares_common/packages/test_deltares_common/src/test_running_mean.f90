module test_running_mean
   ...
   !  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/test/utils_lgpl/deltares_common/packages/test_deltares_common/src/test_running_mean.f90 $
   !!--description-----------------------------------------------------------------
   !
