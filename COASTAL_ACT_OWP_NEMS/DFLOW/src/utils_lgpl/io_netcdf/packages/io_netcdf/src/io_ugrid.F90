...
! $Id: io_ugrid.F90 140737 2022-02-10 16:03:14Z spee $
! $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/releases/140712/src/utils_lgpl/io_netcdf/packages/io_netcdf/src/io_ugrid.F90 $
#ifdef HAVE_CONFIG_H
#include "config.h"
#endif
