...
implicit none
    ...
    character(*),  public, parameter :: delwaq1_major        = '5'
    character(*),  public, parameter :: delwaq1_minor        = '10'
    character(*),  public, parameter :: delwaq1_revision     = '00'
    character(*),  public, parameter :: delwaq1_build_number = '141013M'
